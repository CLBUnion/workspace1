 ...
 * Generated at: 2018-01-18 01:03:41 UTC
...
return;
    ...
    try {
      ...
      out.write("<title>公司信息列表-洋葱头溯源系统</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      ...
      out.write("\t\t\t<caption>公司列表</caption>\r\n");
      out.write("\t\t\t<thead>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th>编号</th>\r\n");
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>{{id}}</td>\r\n");
      out.write("\t\t\t\t\t<td>{{enterpriseCode}}</td>\r\n");
      out.write("\t\t\t\t\t<td>{{enterpriseName}}</td>\r\n");
      out.write("\t\t\t\t\t<td>{{abbreviation}}</td>\r\n");
      out.write("\t\t\t\t\t<td>{{industry}}</td>\r\n");
      out.write("\t\t\t\t\t<td>{{region}}</td>\r\n");
      out.write("\t\t\t\t\t<td>{{responsiblePerson}}</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t{{/each}}\r\n");
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t</table>\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t$.getJSON(config.serverIp+\"or/company/companyPage\",{\"pageNo\":id,\"pageSize\":pageSize },function(data){\r\n");
