				...
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane fade in active" id="base">
						<div class="form-group">
							...
							<input id="num" type="number" class="form-control" required="required" placeholder="请输入数量，例如：5000">
							<span class="help-block">请输入数量，例如：5000</span>
						</div>
						<div class="form-group">
							<label for="batchNo">批号代码*</label>
							<input id="batchNo" type="text" size=6 class="form-control" required="required" placeholder="请输入批号代码，例如：123456">
